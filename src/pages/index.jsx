...
const Index = () => {
	return (
		<main>
			...
			<Layout>
				<img src="/profile.jpeg" alt="One of Hanu's senior pictures where he is sitting and smiling in a field." className="mt-0 rounded-lg shadow-lg" />

				<p className="mt-5">Selam, friend <span className="wave left-1">👋🏾</span></p>

				<p>My name is Hanu. Welcome to my corner of the internet!</p>
				...
				<div className="bg-gray-100 py-2 md:py-5 px-4 md:px-9 rounded-lg">
					<p className="uppercase tracking-widest my-0 text-sm text-gray-400">Current Status</p>
					<p className="my-0 text-gray-600">On spring break before finishing my last quarter of high school.</p>
				</div>
				...
				<div className="flex justify-around mt-34 pt-34">
					...
					<a href="mailto:hanu@hanuasfaw.com" target="_blank" rel="noreferrer">Email</a>
				</div>
			</Layout>
		</main>
	)
